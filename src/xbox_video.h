...
static const VideoMode XCALIBUR_TABLE[] = {
    { 95, 37,  640,  480,  43,   2,  7,  2, 0}, // 01 640x480_NTSC_RGB
    { 95, 37,  720,  480,  41,   6,  7,  6, 0}, // 02 720x480_NTSC_RGB
    { 95, 38,  640,  480,  63,  24,  1, 10, 0}, // 03 640x480_PAL_RGB
    {137, 38,  720,  480,  41,  50,  1, 10, 0}, // 04 720x480_PAL_RGB
    { 95, 41,  640,  576, 127,  47,  6,  6, 0}, // 05 640x576_PAL_RGB
    {137, 41,  720,  576,   5,  45,  6,  6, 0}, // 06 720x576_PAL_RGB
    { 95, 36,  640,  480,  43,   2,  8,  5, 0}, // 07 640x480_480P
    { 95, 36,  720,  480,  41,   6,  8,  5, 0}, // 08 720x480_480P
    {300, 25,  960,  720,  69,  80,  4,  5, 0}, // 09 960x720 ?
    {259, 25, 1280,  720, 110,  40,  5,  5, 0}, // 0A 720p ?
    {259, 25, 1280,  720, 110,  40,  5,  5, 0}, // 0B 720p_60
    {236, 40, 1440, 1080,  43,  88,  4, 10, 0}, // 0C 1440x1080 ?
    {236, 40, 1920, 1080,  43,  88,  4, 10, 0}, // 0D 1080 ?
    {187, 41, 1920, 1080,  92,  40,  3, 10, 0}, // 0E 1080i
    {136, 37,  640,  480,  81,  -1,  7,  6, 0}, // 0F 640x480_FPAR_NTSC_RGB
    {178, 38,  640,  480,  81,  42,  1, 10, 0}, // 10 640x480_FPAR_PAL_RGB
    { 96, 36,  654,  480,  41,  37,  8,  6, 0}, // 11 640x480_FPAR_480P
    {136, 42,  640,  576,  87,  -7,  6,  6, 0}  // 12 640x576_FPAR_PAL_RGB
};

static const VideoMode CONEXANT_TABLE[] = {
    {122, 34,  640,  480,  13,  32, 10,  3, 0}, // 640x480_NTSC_RGB
    {134, 34,  720,  480,  15,  32, 10,  3, 0}, // 720x480_NTSC_RGB
    {254, 36,  640,  480,  55,  32,  8,  3, 0}, // 640x480_PAL_RGB
    {270, 36,  720,  480,  59,  32,  8,  3, 0}, // 720x480_PAL_RGB
    {132, 39,  640,  576,  15,  32,  9,  3, 0}, // 640x576_PAL_RGB
    {148, 39,  720,  576,  17,  33,  9,  3, 0}, // 720x576_PAL_RGB
    {120, 36,  720,  480,  17,  63,  8,  6, 0}, // 640x480_480P
    {120, 36,  720,  480,  17,  63,  8,  6, 0}, // 720x480_480P
    {300, 25,  960,  720,  69,  80,  4,  5, 0}, // 960x720 ?
    {300, 25, 1280,  720,  69,  80,  4,  5, 0}, // 720p ?
    {300, 25, 1280,  720,  69,  80,  4,  5, 0}, // 720p_60
    {236, 40, 1440, 1080,  43,  88,  4, 10, 0}, // 1440x1080 ?
    {236, 40, 1920, 1080,  43,  88,  4, 10, 0}, // 1080 ?
    {235, 41, 1920, 1080,  44,  88,  3, 10, 0}, // 1080i
    {165, 34,  640,  480,  48,  32, 10,  3, 0}, // 640x480_FPAR_NTSC_RGB
    {318, 34,  640,  480,  91,  32, 10,  3, 0}, // 640x480_FPAR_PAL_RGB
    {122, 36,  654,  480,  15,  63,  8,  6, 0}, // 640x480_FPAR_480P
    {179, 39,  640,  576,  48,  32,  9,  3, 0}  // 640x576_FPAR_PAL_RGB
};

static const VideoMode FOCUS_TABLE[] = {
    {180, 26,  640,  480, 115, 64, 18,  2, 0}, // 640x480_NTSC_RGB
    {140, 26,  720,  480,  75, 64, 18,  2, 0}, // 720x480_NTSC_RGB
    {144, 24,  640,  480,  79, 64, 20,  2, 0}, // 640x480_PAL_RGB
    { 84, 24,  720,  480,  59, 64, 20,  2, 0}, // 720x480_PAL_RGB
    {144, 26,  640,  576,  79, 64, 22,  2, 0}, // 640x576_PAL_RGB
    { 84, 26,  720,  576,  59, 64, 22,  2, 0}, // 720x576_PAL_RGB
    {120, 36,  720,  480,  17, 63,  8,  6, 0}, // 640x480_480P
    {120, 36,  720,  480,  17, 63,  8,  6, 0}, // 720x480_480P
    {300, 25,  960,  720,  69, 80,  4,  5, 0}, // 960x720 ?
    {300, 25, 1280,  720,  69, 80,  4,  5, 0}, // 720p ?
    ...
    {236, 40, 1920, 1080,  43, 88,  4, 10, 0}, // 1080 ?
    {235, 41, 1920, 1080,  44, 88,  3, 10, 0}, // 1080i
    {180, 26,  640,  480, 115, 64, 18,  2, 0}, // 640x480_FPAR_NTSC_RGB
    { 44, 24,  640,  480,  79, 64, 20,  2, 0}, // 640x480_FPAR_PAL_RGB
    {122, 36,  654,  480,  15, 63,  8,  6, 0}, // 640x480_FPAR_480P
