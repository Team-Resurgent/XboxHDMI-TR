...
static const VideoMode XCALIBUR_TABLE[] = {
    ...
    { 96, 38,  640,  480,  63,  24,  1, 10, 0}, // 03 640x480_PAL_RGB
    {138, 38,  720,  480,  41,  50,  1, 10, 0}, // 04 720x480_PAL_RGB
    { 96, 42,  640,  576, 127, -47,  6,  6, 0}, // 05 640x576_PAL_RGB
    {138, 42,  720,  576,   5,  45,  6,  6, 0}, // 06 720x576_PAL_RGB
    { 96, 36,  640,  480,  43,   2,  8,  5, 0}, // 07 640x480_480P
    { 96, 36,  720,  480,  41,   6,  8,  5, 0}, // 08 720x480_480P
